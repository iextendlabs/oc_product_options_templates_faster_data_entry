...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
				...
				//option templates extension code starts here
				$data['option_templates']=str_replace('amp;', '',$this->url->link('extension/module/optiontemplates/getForm', 'user_token=' . $this->session->data['user_token'], 'SSL') );
				$data['option_templates_select']=str_replace('amp;', '',$this->url->link('extension/module/optiontemplates/getSelect', 'user_token=' . $this->session->data['user_token'], 'SSL') );
				//option templates extension code ends here
